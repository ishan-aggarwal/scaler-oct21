...
// For every index i,
// find the "distance of" nearest element on the left side of i
// which is smaller than A[i]

// storing the difference of distance between current element (i) and index
// stored at the top of stack

public class PreviousSmallerElementDistance {

	public static int[] nearestPrevSmallestElementDistance(int[] A) {
	...
	public static void main(String[] args) {
		// 0, 1, 2, 3, 4, 5
		int[] A = { 4, 2, 5, 10, 8, 2 };
		// -1,-1, 1, 2, 2,-1 (index of previous smaller element)
		// -1,-1, 1, 1, 2,-1 (distance from nearest previous smaller element)
		int[] res = nearestPrevSmallestElementDistance(A);
